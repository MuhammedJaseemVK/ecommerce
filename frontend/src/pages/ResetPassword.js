                ...
                (<div>
                    <div className="container">
                        <form onSubmit={handleSubmit} className='form-container'>
                            ...
                            <input type="password" id="password" value={password} name="password" onChange={(e) => setPassword(e.target.value)} className="input-field" placeholder="name@email.com" required />
